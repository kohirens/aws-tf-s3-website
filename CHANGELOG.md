...
- HEAD to Default HTTP Methods Allowed

### Fixed

- Duplicate Statement IDs
- Terraform Formatting
- CloudFront Lambda URL Invokation
...
- ACM Validation Sync
- Perform CloudFront Cert Validation

### Regular Maintenance

- Fix Value For Undeclared Variable Warning

## [3.0.6]

### Changed

- Extend CI/CD Wait Time
- ACM Certificate Validation State
- Convert Examples into Testable Modules
...
- Wait For Certificate Manager Validation
- Adjust Route53 Validation Record

### Fixed

- Account and Region Variables
- Deployment Issue with Lambda Function
- Account and Region Variables
- Required Providers

### Regular Maintenance

- Turn on test verbosity.
