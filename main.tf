locals {
  ...
  http_methods = var.all_http_methods ? ["DELETE", "GET", "HEAD", "OPTIONS", "PATCH", "POST", "PUT"] : ["GET", "HEAD", "OPTIONS"]
}
...
resource "aws_cloudfront_distribution" "web" {
  ...
  dynamic "ordered_cache_behavior" { # additional origin cache behavior
    ...
    iterator = behavior
    content {
      allowed_methods          = behavior.value.allowed_methods != null ? behavior.value.allowed_methods : local.http_methods
